...
const Product = () => {
  const { promo, responsive, navigate } = usePromo();
        ...
        {promo?.map((item) => (
          <div className="h-72 w-30 flex justify-center">
            <div className="h-full w-[94%] border border-neutral-600  flex flex-col rounded-md">
              ...
              ></div>
              <div className="w-full h-1/2 pl-1 flex flex-col justify-between">
                <div>
                ...
                <div className="pb-1">
                  <button
                    onClick={() => navigate(`/detailpromo/${item?.id}`)}
                    className="bg-emerald-600 text-white p-1 px-3 rounded-md hover:bg-emerald-700"
                  >
                    Detail
                  </button>
                </div>
