...
import useDetailCategories from "../hooks/useDetailCategories";

const DetailCategories = () => {
  const { categories } = useDetailCategories();
  if (!categories) {
          ...
          <div className="md:w-3/4 lg:w-1/2 text-white text-sm">
            ...
            <p className="flex mb-2">
              ...
              <span
                ...
                style={{ wordBreak: "break-word" }}
              >
                {format(new Date(categories?.createdAt), "dd MMMM yyyy")}
              </span>
            </p>
            <p className="flex mb-2">
              <span className="font-semibold w-2/5 flex justify-between">
              ...
              <span
                ...
                style={{ wordBreak: "break-word" }}
              >
                {format(new Date(categories?.updatedAt), "dd MMMM yyyy")}
              </span>
            </p>
          </div>
        </div>
